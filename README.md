...
In the "Customize Toolbar" page, click the "Tab layout" button in the lower-left corner to choose different navigation bar layouts:
...
在「自定义工具栏」页面左下角，点击「标签页布局」按钮，可以选择不同导航栏布局。
