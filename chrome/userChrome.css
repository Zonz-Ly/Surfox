...
:root {
    --input-color: light-dark( rgba(0, 0, 0, .72), rgba(255, 255, 255, .9) ) !important;
    ...
    --toolbox-textcolor: var(--input-color) !important;
    ...
    --toolbar-color: var(--input-color) !important;
    --in-content-page-color: var(--input-color) !important;
    --toolbar-field-color: light-dark( rgba(0, 0, 0, .72), rgb(255, 255, 255) ) !important;
    --toolbar-field-focus-color: var(--toolbar-field-color) !important;
    --tab-selected-textcolor: var(--toolbar-field-color) !important;
    @media (prefers-color-scheme: dark) {
        --toolbar-color: rgba(255, 255, 255, .9) !important;
    }
}
...
:root {
    --button-background-color: light-dark( rgba(0, 0, 0, .0255), rgba(255, 255, 255, .0325) ) !important;
    --button-background-color-hover: light-dark( rgba(0, 0, 0, .051), rgba(255, 255, 255, .065) ) !important;
    --button-background-color-active: light-dark( rgba(0, 0, 0, .102), rgba(255, 255, 255, .13) ) !important;
    ...
    --tab-hover-background-color: light-dark( rgba(0, 0, 0, .054), rgba(255, 255, 255, .075) ) !important;
    ...
    --newtab-button-static-hover-background: light-dark(#F0F0F0, #434343) !important;
    --newtab-button-static-active-background: light-dark(#E3E3E3, #505050) !important;
    --toolbar-bgcolor: light-dark(#FDFDFD, #363636) !important;
    --input-bgcolor: light-dark(#FFFFFF, #434343) !important;
    ...
    --arrowpanel-border-color: light-dark( rgba(0, 0, 0, .1185), rgba(255, 255, 255, .1194) ) !important;
    ...
    --in-content-page-background: var(--input-bgcolor) !important;
    ...
    --toolbox-bgcolor: light-dark(#F1F1F1, #1F1F1F) !important;
...
.infobar {
    --info-bar-background-color: light-dark(rgba(255, 255, 255, .75), rgba(255, 255, 255, .065)) !important;
    --info-bar-text-color: var(--input-color) !important;
}
...
:root {
    ...
    --tabbar-separator-color: light-dark( rgba(0, 0, 0, .075), rgba(255, 255, 255, .223) );
...
:root:not([uidensity="mix"]) {
    ...
    #tabbrowser-tabs .tab-close-button {
        ...
        &:hover {
            background-color: light-dark( rgba(0, 0, 0, .10), rgba(255, 255, 255, .17) ) !important;
        }
        &:hover:active {
            background-color: light-dark( rgba(0, 0, 0, .27), rgba(255, 255, 255, .315) ) !important;
        }
    ...
    .tab-label-container:not([selected], [multiselected]):not(:-moz-window-inactive) {
        @media (prefers-color-scheme: light) {
            opacity: .735 !important;
        }
        @media (prefers-color-scheme: dark) {
            opacity: .612 !important;
        }
    }
}
...
:root[uidensity="mix"] {
    ...
    .tabbrowser-tab {
        @media (prefers-reduced-motion: no-preference) {
            #tabbrowser-tabs[movingtab] &[fadein]:not([selected]):not([multiselected]), &[multiselected-move-together] {
    ...
    #urlbar .tab-close-button {
        ...
        #urlbar:not([focused]) .urlbar-input-container[hovered] & {
            margin-inline-end: 0 !important;
            opacity: 1 !important;
        }
    }
    
    #urlbar .urlbar-input-container >span {
        transition: margin-inline-end 200ms;
        #urlbar:not([focused]) .urlbar-input-container[hovered] & {
            margin-inline-end: max(calc(-1 * var(--span-width)), -20px) !important;
        }
    }
